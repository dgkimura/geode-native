...
StatisticDescriptor* StatisticDescriptorImpl::createIntCounter(
    ...
    int8_t isLargerBetter) throw(OutOfMemoryException) {
...
int8_t StatisticDescriptorImpl::isCounter() { return isStatCounter; }

int8_t StatisticDescriptorImpl::isLargerBetter() { return isStatLargerBetter; }
